...
The Radiance API allows the user to build their graphics application quickly, while the engine handles all the other low-level necessities. This engine strives to be as platform independent as possible
