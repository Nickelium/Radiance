...
namespace Radiance
{
	...
	void Logger::Init()
	{
		...
		m_ClientLogger = std::make_shared<spdlog::logger>("CLI", m_ClientSinks.begin(), m_ClientSinks.end());
		...
		m_CoreLogger = std::make_shared<spdlog::logger>("CORE", m_CoreSinks.begin(), m_CoreSinks.end());
