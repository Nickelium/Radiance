...
namespace Radiance
{
	FlyPerspective::FlyPerspective(float _speed, float _sensitivity)
	...
	void FlyPerspective::Update(DataTime _time)
	{
		UpdateAttributes(_time);
		UpdateMatrices();
	}

	void FlyPerspective::UpdateAttributes(DataTime _time)
	{
