...
#include "Platform/API/OpenGL/GLPlatformContext.h"

#define GLFW_EXPOSE_NATIVE_WIN32
#include <GLFW/glfw3native.h>
#include "Platform/API/DX11/DXPlatformContext.h"
...
namespace Radiance
{
	...
	void WindowsWindow::Init(const WindowDesc& _desc)
	{
		...
		m_Window = glfwCreateWindow((int)_desc.Width, (int)_desc.Height, 
			(std::string(APIName) + " : " + m_Data.Title ).c_str(), nullptr, nullptr);
