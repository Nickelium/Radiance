...
namespace Radiance
{
	...
	GLPlatformContext::GLPlatformContext(GLFWwindow* _windowHandle)
		: m_WindowHandle(_windowHandle)
	{
		RAD_CORE_ASSERT(m_WindowHandle, "Windows Handle is nullptr");	
	}

	void GLPlatformContext::Init()
	{
		RAD_CORE_ASSERT(m_WindowHandle, "Windows Handle is nullptr");
	...
	void GLPlatformContext::SwapBuffers()
	{
		RAD_CORE_ASSERT(m_WindowHandle, "Windows Handle is nullptr");
